                    ...
                    <div className='m-4'>
                        <div className="row" style={{ marginTop: '9vh' }}>
                            <div className="col-lg-6 col-sm-12 mx-auto  ">
                                <p style={{ fontSize: '4vh', textDecoration: 'underline', color: 'white', fontStyle: 'normal' }}>Prinipal's Message</p>
                                <img src={principal} className="" alt="..." style={{ height: '40vh', width: '40vh', borderRadius: '50%' }} />

                            </div>
                            <div className="col-lg-6 col-sm-12 bl"  >

                                <p style={{textAlign:'justify',display:'inline-block' , color: 'black', fontWeight: '500', fontStyle: 'normal', fontSize: '2vh', marginTop: '7vh' }}>With immense excitement,we gair up for much awaited event FIESTA'23. This fest brings up carefully curated lineup events and activities, we aim to provide a platform for each and every one of you to showcase your unique talents and explore the rich tapestry of cultural traditions that thrive within our college.encourage all of the vistors and also the students of our college actively participate in the fest, whether it be by performing on stage, joining the organizing committees, or supporting fellow students as enthusiastic spectators. This is an opportunity to step out of your comfort zones, push your boundaries, and create lasting memories that will stay with you. I extend my heartfelt gratitude to the faculty members, staff and student volunteers who have been working tirelessly to make this cultural fest a resounding success. Their dedication, creativity and enthusiasm have been instrumental in shaping this event into an unforgettable experience for all of us. I am eagerly looking forward to witnessing the talents, creativity, and enthusiasm that you will bring to our college cultural fest. Let us unite as a community and make this event a vibrant and memorable celebration of our cultural heritage. Wishing you all the very best in your preparations!</p>
